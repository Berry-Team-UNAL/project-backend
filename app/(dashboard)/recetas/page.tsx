...
const mockVersions: SubRecipeVersion[] = [
	{
		...
		version: "V3",
		name: "Masa madre 48h",
		description: "Fermentaci&oacute;n reducida para producci&oacute;n r&aacute;pida",
		costPerKg: 2.45,
		date: "2026-06-10",
		isActive: true,
	},
	{
		...
		version: "V2",
		name: "Masa madre 72h",
		description: "Fermentaci&oacute;n est&aacute;ndar con mejor sabor",
		costPerKg: 2.68,
		date: "2026-05-15",
		isActive: true,
	},
	{
		...
		version: "V1",
		name: "Masa madre 96h",
		description: "Fermentaci&oacute;n larga - versi&oacute;n original",
		costPerKg: 2.92,
		date: "2026-04-01",
		isActive: false,
	},
